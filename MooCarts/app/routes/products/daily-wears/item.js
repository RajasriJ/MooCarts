...
export default class ProductsDailyWearsItemRoute extends Route {
    model(params) {
        if (params.item_id == 'Babydoll dress') {
          return [{ name: 'Babydoll dress Rs.30,000', img: '/assets/images/dress1.jpeg' }];
        } else if (params.item_id == 'Wrap around') {
          return [{ name: 'Wrap around Rs.2000', img: '/assets/images/dress2.jpg' }];
          ...
          return [{ name: 'Bubble dress Rs.14,000', img: '/assets/images/dress4.jpeg' }];
        }else if(params.item_id=='Polo dress'){
            return[{img:'/assets/images/dress5.jpeg',name:'Polo dress Rs.1500'}]      }
         else {
